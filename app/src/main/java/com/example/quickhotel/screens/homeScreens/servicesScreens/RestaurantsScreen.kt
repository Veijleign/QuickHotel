...
fun RestaurantsScreenContent(
    ...
    var currentBottomSheetRestaurantDescription = remember {
        mutableStateOf(R.string.restaurant_sheet_description)
    }
    var currentBottomSheetRestaurantPhoto = remember {
    ...
    BottomSheetScaffold(
        ...
        sheetContent = {
            BottomSheetRestaurantInformation(
                currentBottomSheetRestaurantDescription.value,
                currentBottomSheetRestaurantPhoto.value
            )
        },
                ...
                Card(
                    ...
                    onClick = {
                        coroutineScope.launch {
                            currentBottomSheetRestaurantPhoto.value = card.image
                            currentBottomSheetRestaurantDescription.value = card.description
...
@Composable
fun BottomSheetRestaurantInformation(
    description: Int,
    photo: Int,
) {
    Column(
        ...
        Box(
            ...
            Column(
                ...
                Column(
                    ...
                    Log.d("${LogClass.QHApp}", "RestaurantDescription: $description")
